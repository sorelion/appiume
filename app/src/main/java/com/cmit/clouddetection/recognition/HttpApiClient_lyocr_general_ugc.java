...
public class HttpApiClient_lyocr_general_ugc extends HttpApiClient{
    public final static String HOST = "ocrapi-ugc.taobao.com";
    static HttpApiClient_lyocr_general_ugc instance = new HttpApiClient_lyocr_general_ugc();
    public static HttpApiClient_lyocr_general_ugc getInstance(){return instance;}
